...
public class EasyReader extends BufferedReader {
    ...
    /**
     * Create a new Parseur.EasyReader that reads from standard input
     */
    public EasyReader() {
    ...
    /**
     * Create a new Parseur.EasyReader that reads from a text file
	...
	System.err.println("Error in Parseur.EasyReader - "+s);
	System.err.flush();
	System.exit(0);
    }
